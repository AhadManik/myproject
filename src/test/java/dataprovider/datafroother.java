...
public class datafroother {

	
	
	public WebDriver driver;
	@Test (dataProvider = "TNlogin", dataProviderClass = dataofTNregnlogin.class )
	...
	@Test (priority=1,dataProvider="TNregister",dataProviderClass= dataofTNregnlogin.class)
