...
public class utilities {
		...
		public WebDriver driver;
			...
			driver.switchTo().newWindow(newWin)
			...
			public void confirm_pass_testregister() {
				...
				driver.findElement(By.xpath("//input[@id='input-email']")).sendKeys("ahsvfdjd@gmail.com");//we need to take care of this
